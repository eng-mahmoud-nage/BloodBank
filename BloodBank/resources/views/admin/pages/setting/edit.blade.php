...
@section('content')
    ...
    <div class="form-group col-md-6">
        {{Form::label('e_mail', 'E_mail' )}}
        {{Form::text('e_mail', $record->e_mail, ['class' => 'form-control'])}}
    </div>
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
        {{Form::label('about_app', 'About Us' )}}
        {{Form::textarea('about_app', $record->about_app, ['class' => 'form-control'])}}
    </div>
    <div class="form-group col-md-6">
        {{Form::label('notification_setting_text', 'Notification Content' )}}
        {{Form::textarea('notification_setting_text', $record->notification_setting_text, ['class' => 'form-control'])}}
    </div>
    </div>
