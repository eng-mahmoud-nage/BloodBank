...
@section('content')
    ...
    @if(count($records)<1)
        <div class="alert alert-warning">
            whoops! : You don`t have Governorates.
        </div>
    @endif

    <div class="card">
        <div class="card-header">
            <a class="btn btn-outline-primary" style="width: 100px;" href="{{url(route('governorate.create'))}}">
                                ...
                                @foreach($records as $record)
                                    @if($loop->odd)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-group-vertical" style="width: 90%; margin-left: 5%" href="{{url(route('governorate.edit', $record->id))}}">
                                                    <i class="fa fa-edit" ></i>
                                                </a>
                                            </td>
                                            <td>
                                                {!! Form::open(['method' => 'POST', 'action' => ['GovernorateController@destroy', $record->id]]) !!}
