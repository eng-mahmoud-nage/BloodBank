...
@section('content')
    ...
    @if(count($records)<1)
        <div class="alert alert-warning">
            whoops! : You don`t have Donations.
        </div>
    @endif
                                ...
                                @foreach($records as $record)
                                    @if($loop->odd)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <a class="btn btn-warning btn-group-vertical" style="width: 90%; margin-left: 5%" href="{{url(route('donation.show', $record->id))}}">
                                                    <i class="fa fa-book-open"></i>
                                                </a>
                                            </td>
                                            <td>
                                                {!! Form::open(['method' => 'POST', 'action' => ['DonationRequestController@destroy', $record->id]]) !!}
